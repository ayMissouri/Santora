...
public final class ExtractorCanvas implements SantoraCanvas {

	private final GuiGraphicsExtractor gfx;
	private final Font font;

	public ExtractorCanvas(GuiGraphicsExtractor gfx) {
		this.gfx = gfx;
	...
	public void textCentered(String text, int centerX, int y, int argb) {
		gfx.centeredText(font, text, centerX, y, argb);
	}
